...
import { useTheme } from "../theam-provider/TheamProvider"
                ...
                <div className="max-w-md mx-auto rounded-xl shadow-md  border overflow-hidden md:max-w-4xl">
                  <div className="md:flex">
                    ...
                    <div className="p-8">
                      ...
                      <div className="flex flex-row gap-3" onClick={(e) => e.stopPropagation()}>
                        <div className='flex gap-2'  >
                          {blog.likes.some((like: any) => like._id === currentUser?._id) ? (
                            <Heart onClick={(e) => {
                        ...
                        <p className="text-sm text-gray-500">{blog?.likes?.length}</p>
                        <div className='flex gap-2'>
                          <Command />
                          <p className="text-sm text-gray-500">{blog?.comments?.length}</p>
                        </div>
